...
const translations = {
  th: {
    ...
    basedOnRisk: "อ้างอิงระดับความเสี่ยงจากความร้อน",
  ...
  en: {
    ...
    basedOnRisk: "Based on risk level from heat",
    ...
    assess: "Assess",
    history: "History",
    footerOrg: "Supported under research grants from Suranaree University of Technology (SUT), the Thailand Science Research and Innovation (TSRI), and the National Research Council of Thailand (NRCT). Project code 215731.",
